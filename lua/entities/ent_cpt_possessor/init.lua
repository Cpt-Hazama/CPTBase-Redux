...
-- 	self.Possessor:SetNW2Bool("CPTBase_IsPossessing",true)
-- 	self.Possessor:SetNW2String("CPTBase_PossessedNPCClass",self.PossessedNPC:GetClass())
-- 	self.Possessor:SetNW2Entity("CPTBase_PossessedNPC",self.PossessedNPC)
...
-- 		self.Possessor:SetNW2Bool("CPTBase_IsPossessing",false)
-- 		self.Possessor:SetNW2String("CPTBase_PossessedNPCClass",nil)
-- 		self.Possessor:SetNW2Entity("CPTBase_PossessedNPC",NULL)
